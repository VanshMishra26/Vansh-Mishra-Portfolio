...
- `styles.css` - responsive Spotify-inspired design system
- `script.js` - scroll spy, search, modal interactions, shelf controls, and accent picker
- `assets/Vansh-Mishra-Resume-July-2026.pdf` - downloadable resume
